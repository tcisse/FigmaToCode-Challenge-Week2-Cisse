...
export function ZaraSection() {
  return (
    <div className="relative lg:mt-16 overflow-hidden h-[50vh] sm:h-[60vh] lg:h-[70vh] w-full lg:mb-10">
      ...
      />
      <div className="text-white flex flex-col xl:gap-8 gap-4 2xl:gap-16 justify-end pb-4 lg:pb-8 xl:pb-16 absolute bottom-0 2xl:w-1/4 xl:w-[35%] lg:w-[40%] md:w-[50%] right-0 lg:-translate-x-2/4">
        <img
