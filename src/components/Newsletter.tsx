  ...
  return (
    <div className="bg-black-5 py-32">
      <div className="max-w-7xl mx-auto mb-20">
        <h1 className=" text-5xl font-medium font-roboto uppercase text-center mb-10">
      ...
      <div className="max-w-3xl mx-auto">
        <h3 className=" text-5xl font-roboto font-medium text-center mb-10">
          Or subscribe to the newsletter
        </h3>
        <div className="flex items-center gap-4 font-open-sans">
          <input
            type="text"
            className="w-full p-2 border-b-2 bg-transparent text-black-50 border-black-50"
            placeholder="Email address..."
          />
          <input type="submit" value="SUBMIT" className="border-b-2 border-black-50 p-2" />
        </div>
      </div>
    </div>
  );
